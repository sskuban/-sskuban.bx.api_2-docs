...
|------------------|------------------|---------------|
| `result[status]` | `responseStatus` | Статус ответа |
| `result[data]`   | `array(article)` | Список статей |
...
|------------------|------------------|---------------|
| `result[status]` | `responseStatus` | Статус ответа |
| `result[data]`   | `array(video)`   | Список видео  |
...
|---------------------------|------------------------|------------------------|
| `result[status]`          | `responseStatus`       | Статус ответа          |
| `result[data]`            | `array(project)`       | Список проектов        |
| `result[lists]`           | `array`                | Вспомогательные списки |
| `result[lists][statuses]` | `array(projectStatus)` | Статусы проектов       |
...
|------------------|------------------|-------------------|
| `result[status]` | `responseStatus` | Статус ответа     |
| `result[data]`   | `array(doc)`     | Список документов |
...
|--------------------------------|------------------|------------------------|
| `result[status]`               | `responseStatus` | Статус ответа          |
| `result[data]`                 | `array(user)`    | Список пользователей   |
| `result[lists]`                | `array`          | Вспомогательные списки |
| `result[lists][cities]`        | `array(city)`    | Города                 |
| `result[lists][workPositions]` | `array`          | Должности              |
...
|---------------------------------|------------------|---------------|
| `result[status]`                | `responseStatus` | Статус ответа |
| `result[residential_complexes]` | `array(complex)` | Список ЖК     |
